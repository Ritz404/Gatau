  ...
  return (
    <footer className="w-full bg-base-300 shadow-xl p-5 flex flex-col items-center space-y-5">
      ...
      <div className="flex space-x-5 items-center">
        <a href="https://github.com/Dovakiin0/ShiroNime" target="_blank">
      ...
      <p className="text-sm text-gray-300">
        ShiroNime does not store any files on the server, we only link to the
        media which is hosted on 3rd party services.
      </p>
      <p className="text-sm text-gray-300">&copy; ShiroNime</p>
    </footer>
  );
};
